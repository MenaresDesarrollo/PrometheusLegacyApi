...
using PrometheusLegacyApi.Entities.Infante;

namespace PrometheusLegacyApi.Persistence;

public partial class InfanteDbContext : DbContext
{
    public InfanteDbContext()
    {
    }

    public InfanteDbContext(DbContextOptions<InfanteDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<DatoFichaGinecologiaJspPrev> DatoFichaGinecologiaJspPrevs { get; set; }

    public virtual DbSet<DatoFichaOftalmologiaJsp> DatoFichaOftalmologiaJsps { get; set; }

    public virtual DbSet<DatoFichaOftalmologiaJspPrev> DatoFichaOftalmologiaJspPrevs { get; set; }

    public virtual DbSet<DatoFichaPrev> DatoFichaPrevs { get; set; }

    public virtual DbSet<DatoFichaPsicologiaJsp> DatoFichaPsicologiaJsps { get; set; }

    public virtual DbSet<DatoFichaPsicologiaJspPrev> DatoFichaPsicologiaJspPrevs { get; set; }
    ...
    public virtual DbSet<FichaSalavarrium> FichaSalavarria { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=10.10.1.230;port=3306;database=labo_center_infante;user=developer;password=123456..;charset=utf8", Microsoft.EntityFrameworkCore.ServerVersion.Parse("5.6.45-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DatoFicha>(entity =>
        {
            ...
            entity.Property(e => e.ObservacionesExamenFisico)
                .HasColumnType("text")
                .HasColumnName("observaciones_examen_fisico");
        ...
        modelBuilder.Entity<DatoFichaGinecologiaJspPrev>(entity =>
        {
            entity.HasKey(e => e.DfginecologiaId).HasName("PRIMARY");

            entity.ToTable("dato_ficha_ginecologia_jsp_prev");
        ...
        modelBuilder.Entity<DatoFichaOftalmologiaJspPrev>(entity =>
        {
            entity.HasKey(e => e.DfoftalmologiaId).HasName("PRIMARY");

            entity.ToTable("dato_ficha_oftalmologia_jsp_prev");
        ...
        modelBuilder.Entity<DatoFichaPrev>(entity =>
        {
            entity.HasKey(e => e.DtfId).HasName("PRIMARY");

            entity.ToTable("dato_ficha_prev");
        ...
        modelBuilder.Entity<DatoFichaPsicologiaJspPrev>(entity =>
        {
            entity.HasKey(e => e.DfpsicologiaId).HasName("PRIMARY");

            entity.ToTable("dato_ficha_psicologia_jsp_prev");
        ...
        modelBuilder.Entity<FichaSalavarrium>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ficha_salavarria");
            ...
            entity.Property(e => e.EspecialidadMedico)
                .HasMaxLength(255)
                .HasColumnName("especialidad_medico");
            entity.Property(e => e.FichaText)
                .HasColumnType("text")
                .HasColumnName("ficha_text");
