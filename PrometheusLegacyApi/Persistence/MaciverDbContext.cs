...
using PrometheusLegacyApi.Entities.Maciver;

namespace PrometheusLegacyApi.Persistence;

public partial class MaciverDbContext : DbContext
{
    public MaciverDbContext()
    {
    }

    public MaciverDbContext(DbContextOptions<MaciverDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Arancel1> Arancel1s { get; set; }
    ...
    public virtual DbSet<BoletaSoftland> BoletaSoftlands { get; set; }
    ...
    public virtual DbSet<OldAgendaOld> OldAgendaOlds { get; set; }

    public virtual DbSet<OldPaciente> OldPacientes { get; set; }

    public virtual DbSet<OldProcedimientoOld> OldProcedimientoOlds { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=10.10.1.248;port=3306;database=labo_center_maciver;user=developer;password=123456..;charset=utf8", Microsoft.EntityFrameworkCore.ServerVersion.Parse("5.6.45-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Arancel>(entity =>
        {
            ...
            entity.Property(e => e.Lista24)
                .HasMaxLength(100)
                .HasComment("BIOGEN")
                .HasColumnName("lista_24");
            entity.Property(e => e.Lista25)
                .HasMaxLength(100)
                .HasComment("INMUNOMEDICA")
                .HasColumnName("lista_25");
            entity.Property(e => e.Lista26)
                .HasMaxLength(100)
                .HasComment("WORKMED - TECNOMEDICA")
                .HasColumnName("lista_26");
            entity.Property(e => e.Lista27)
                .HasMaxLength(100)
                .HasComment("COVISA")
                .HasColumnName("lista_27");
        ...
        modelBuilder.Entity<Arancel1>(entity =>
        {
            entity.HasKey(e => e.AranId).HasName("PRIMARY");
        ...
        modelBuilder.Entity<BoletaSoftland>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("boleta_softland")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");

            entity.Property(e => e.BodegaOrigenDeLosProductos)
                .HasMaxLength(255)
                .HasColumnName("Bodega_Origen_de_los_Productos");
            ...
            entity.Property(e => e.CiudadDelCliente)
                .HasMaxLength(255)
                .HasColumnName("Ciudad_del_Cliente");
            entity.Property(e => e.CodigoCentroDeCosto)
                .HasMaxLength(255)
                .HasColumnName("Codigo_Centro_de_Costo");
            entity.Property(e => e.CodigoCondicionDePago)
                .HasMaxLength(255)
                .HasColumnName("Codigo_Condicion_de_Pago");
            ...
            entity.Property(e => e.CodigoDeVendedor)
                .HasMaxLength(255)
                .HasColumnName("Codigo_de_Vendedor");
            entity.Property(e => e.CodigoUnidadDeMedida)
                .HasMaxLength(255)
                .HasColumnName("Codigo_Unidad_de_Medida");
            entity.Property(e => e.ComunaDelCliente)
                .HasMaxLength(255)
                .HasColumnName("Comuna_del_Cliente");
            entity.Property(e => e.ConceptoDelDocumento)
                .HasMaxLength(255)
                .HasColumnName("Concepto_del_Documento");
            entity.Property(e => e.ConservaFolioAsignadoAlDte)
                .HasMaxLength(255)
                .HasColumnName("Conserva_Folio_Asignado_al_DTE");
            entity.Property(e => e.DescripcionDelProducto)
                .HasMaxLength(255)
                .HasColumnName("Descripcion_del_Producto");
            entity.Property(e => e.DetalleDelProducto)
                .HasMaxLength(255)
                .HasColumnName("Detalle_del_Producto");
            entity.Property(e => e.DireccionDelCliente)
                .HasMaxLength(255)
                .HasColumnName("Direccion_del_Cliente");
            entity.Property(e => e.EstadoDelDocumento)
                .HasMaxLength(255)
                .HasColumnName("Estado_del_Documento");
            entity.Property(e => e.FechaDeGeneracionDelDocumento)
                .HasMaxLength(255)
                .HasColumnName("Fecha_de_Generacion_del_Documento");
            entity.Property(e => e.FechaDeVencimientoDelDocumento)
                .HasMaxLength(255)
                .HasColumnName("Fecha_de_Vencimiento_del_Documento");
            entity.Property(e => e.Folio).HasMaxLength(255);
            entity.Property(e => e.GiroDelCliente)
                .HasMaxLength(255)
                .HasColumnName("Giro_del_Cliente");
            entity.Property(e => e.MailDteDelCliente)
                .HasMaxLength(255)
                .HasColumnName("Mail_DTE_del_Cliente");
            entity.Property(e => e.NDireccionDelCliente)
                .HasMaxLength(255)
                .HasColumnName("N_Direccion_del_Cliente");
            entity.Property(e => e.NombreDelCliente)
                .HasMaxLength(255)
                .HasColumnName("Nombre_del_Cliente");
            entity.Property(e => e.NumeroDeDocumento)
                .HasMaxLength(255)
                .HasColumnName("Numero_de_Documento");
            entity.Property(e => e.Observacion).HasMaxLength(255);
            entity.Property(e => e.PrecioUnitarioMonedaBase)
                .HasMaxLength(255)
                .HasColumnName("Precio_Unitario_Moneda_Base");
            entity.Property(e => e.PrecioUnitarioMonedaDeVenta)
                .HasMaxLength(255)
                .HasColumnName("Precio_Unitario_Moneda_de_Venta");
            entity.Property(e => e.RecId)
                .HasMaxLength(255)
                .HasColumnName("REC_ID");
            entity.Property(e => e.RutDelCliente)
                .HasMaxLength(255)
                .HasColumnName("Rut_del_Cliente");
            entity.Property(e => e.SubtipoDelDocumento)
                .HasMaxLength(255)
                .HasColumnName("Subtipo_del_Documento");
            entity.Property(e => e.TipoDeDocumentoDeVenta)
                .HasMaxLength(255)
                .HasColumnName("Tipo_de_Documento_de_Venta");
        ...
        modelBuilder.Entity<CuestionarioPacienteHistorial>(entity =>
        {
            ...
            entity
                .ToTable("cuestionario_paciente_historial")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<CuestionarioProfesional>(entity =>
        {
            ...
            entity
                .ToTable("cuestionario_profesional")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<DatoFichaGinecologiaJsp>(entity =>
        {
            ...
            entity
                .ToTable("dato_ficha_ginecologia_jsp")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<DatoFichaOftalmologiaJsp>(entity =>
        {
            ...
            entity
                .ToTable("dato_ficha_oftalmologia_jsp")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<DatoFichaPsicologiaJsp>(entity =>
        {
            ...
            entity
                .ToTable("dato_ficha_psicologia_jsp")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<FormaPagoHasCampoPago>(entity =>
        {
            ...
            entity
                .ToTable("forma_pago_has_campo_pagos")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<LaboratorioRestMessage>(entity =>
        {
            ...
            entity
                .ToTable("laboratorio_rest_messages")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<OldAgendaOld>(entity =>
        {
            entity.HasKey(e => e.AgeId).HasName("PRIMARY");

            entity
                .ToTable("old_agenda_old")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<OldPaciente>(entity =>
        {
            entity.HasKey(e => e.PacId).HasName("PRIMARY");

            entity
                .ToTable("old_paciente")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<OldProcedimientoOld>(entity =>
        {
            entity.HasKey(e => e.ProId).HasName("PRIMARY");

            entity
                .ToTable("old_procedimiento_old")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<ParametrosEtiquetas1>(entity =>
        {
            ...
            entity
                .ToTable("parametros_etiquetas_1")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<PreguntasCuestionario>(entity =>
        {
            ...
            entity
                .ToTable("preguntas_cuestionario")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<ProcedimientoHasProfesional>(entity =>
        {
            ...
            entity
                .ToTable("procedimiento_has_profesional")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<ProcedimientoModalidad>(entity =>
        {
            ...
            entity
                .ToTable("procedimiento_modalidad")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ProcedimientoModalidadProModalidadId", "ModalidadInformacionModId")
                            ...
                            .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
                        j
                            .ToTable("procedimiento_modalidad_has_modalidad_informacion")
                            .HasCharSet("utf8")
                            .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<ProcedimientoValidacion>(entity =>
        {
            ...
            entity
                .ToTable("procedimiento_validacion")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ProfesionalProId", "EspecialidadEspId")
                            ...
                            .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
                        j
                            .ToTable("profesional_has_especialidad")
                            .HasCharSet("utf8")
                            .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<ProfesionalHasSucursalHasSubUnidad>(entity =>
        {
            ...
            entity
                .ToTable("profesional_has_sucursal_has_sub_unidad")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<SoftlandSoapMessage>(entity =>
        {
            ...
            entity
                .ToTable("softland_soap_messages")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("SubUnidadSubId", "ProcedimientoProId")
                            ...
                            .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
                        j
                            .ToTable("sub_unidad_has_procedimiento")
                            .HasCharSet("utf8")
                            .UseCollation("utf8_general_ci");
        ...
        modelBuilder.Entity<SucursalHasSubUnidad>(entity =>
        {
            ...
            entity
                .ToTable("sucursal_has_sub_unidad")
                .HasCharSet("utf8")
                .UseCollation("utf8_general_ci");
